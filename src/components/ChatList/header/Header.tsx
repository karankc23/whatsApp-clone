  ...
  return (
    <div className="left-header">
      <div className="left-header-profile-details">
        <img
          className="left-header-profile-image"
          src="https://img1.hscicdn.com/image/upload/f_auto,t_ds_square_w_640,q_50/lsci/db/PICTURES/CMS/316600/316692.png"
        />
        <div className="left-header-user-name">Pat Cummins (You)</div>
      </div>
